# Generated by Django 3.0.3 on 2020-03-21 02:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pv', models.IntegerField(default=0, verbose_name='page blog')),
                ('tag', models.CharField(choices=[('R', 'reprint'), ('O', 'original')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bukobook.Article')),
